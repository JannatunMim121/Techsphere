...
const generateMasterPDF = (routine, res) => {
  ...
  // Column widths within each day - increased for teacher names
  const courseColWidth = 45;   // Course code
  const sectionColWidth = 55;  // Section name
  const roomColWidth = 45;     // Room number
  const teacherColWidth = pageWidth - timeColWidth - courseColWidth - sectionColWidth - roomColWidth; // Rest for teacher (largest)
